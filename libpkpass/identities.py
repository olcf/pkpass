...
class IdentityDB(object):
  ...
  def load_certs_from_directory(self, certpath, cabundle):
    ...
    for key in self.iddb.keys():
      ...
      self.iddb[key]['fingerprint'] = crypto.get_cert_fingerprint( self.iddb[key] )
      ...
      self.iddb[key]['issuerhash'] = crypto.get_cert_issuerhash( self.iddb[key] )
      self.iddb[key]['subjecthash'] = crypto.get_cert_subjecthash( self.iddb[key] )
